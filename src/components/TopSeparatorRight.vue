<template>
  <!-- ななめ背景部 -->
  <div class="h-48 lg:h-64 bg-gray-200 hoverflow-hidden">
    <div class="h-48 lg:h-64 bg-gray-200 transform origin-top-right -skew-y-3">
      <div class="h-48 lg:h-64 pt-16 lg:pt-20 text-center transform skew-y-3">
